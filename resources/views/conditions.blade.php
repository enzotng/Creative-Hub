...
<body>
    ...
    <main id="conditionsMain">

        <section class="conditions shadow-md flex flex-wrap items-center">

            <div class="headerConditions">
                <h1>Conditions Générales d'Utilisation</h1>
                <p>En vigueur au 08/04/2023</p>
            </div>

            <p>Les présentes conditions générales d'utilisation (dites « CGU ») ont pour objet l'encadrement juridique
                des modalités de mise à disposition du site et des services par Enzo Tang et de définir les
            ...
            <p>
                ...
                https://creativehub.enzotang.fr se réserve le droit de modifier unilatéralement et à tout moment le
            ...
            <p>
                L'édition et la direction de la publication du site https://creativehub.enzotang.fr est assurée par Enzo
                Tang;
                <br>
                Adresse e-mail : creativehub@enzotang.fr
                <br>
                L'hébergeur du site https://creativehub.enzotang.fr est la société GROUPE LWS, dont le siège social
                est situé au 10 Rue de Penthièvre, 75008 Paris, avec le numéro de téléphone : 01 77 62 30 03.
            </p>

            <h3>Article 2 : Accès au site</h3>

            <p>Le site https://creativehub.enzotang.fr permet à l'Utilisateur un accès gratuit aux services suivants :
            </p>
            ...
            <p>Creative Hub est une plateforme en ligne moderne pour présenter des projets créatifs tels que la
                conception graphique, le développement web, la photographie, l'art ou tout autre type de projet. Avec
                les dernières technologies telles que AngularJS et Laravel, Creative Hub permet de créer un portfolio
                professionnel et attractif en ligne.
            </p>
            ...
            <p>Tout Utilisateur membre régulièrement inscrit pourra également solliciter sa désinscription en se
                ...
                la responsabilité de https://creativehub.enzotang.fr. Dans ces cas, l'Utilisateur accepte ainsi ne pas
            ...
            <p>
                ...
                et aux libertés. Le site est déclaré à la CNIL sous le numéro (TBD).
            </p>
            ...
            <ul>
                <li>
                    par mail à l'adresse email suivante : creativehub@enzotang.fr
                </li>
                <li>
                    via le formulaire de contact : https://creativehub.enzotang.fr/contact/
                </li>
            </ul>
            ...
            <p>
                La marque Creative Hub est une marque déposée par Enzo Tang.Toute représentation et/ou
            ...
            <p>
                Les sources des informations diffusées sur le site https://creativehub.enzotang.fr sont réputées fiables
            ...
            <p>
                ...
                Malgré des mises à jour régulières, le site https://creativehub.enzotang.fr ne peut être tenu
            ...
            <p>
                Le site https://creativehub.enzotang.fr ne peut être tenu pour responsable d'éventuels virus qui
            ...
            <p>
                ...
                ces
                liens, il sortira du site https://creativehub.enzotang.fr. Ce dernier n'a pas de contrôle sur les pages
                web
            ...
            <p>
                ...
                https://creativehub.enzotang.fr. Les cookies ne contiennent pas d'information personnelle et ne
            ...
            <p>Le site permet aux membres de publier les contenus suivants : Projets.</p>
